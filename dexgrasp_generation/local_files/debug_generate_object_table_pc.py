...
def sample_projected(_):
    ...
    for pose_matrix in pose_matrices:
        ...
        for idx_camera in range(len(camera_eye)):
            ...
            points_opengl_object = position[..., :3][(position[..., 2] != 0) & (seg_labels[..., 1] == 1)]
            ...
            points_opengl_table = position[..., :3][(position[..., 2] != 0) & (seg_labels[..., 1] == 2)]
        ...
        s_ply_path = "/home/pxn-lyj/Egolee/programs/UniDexGrasp_liyj/dexgrasp_generation/local_files/data/table_pcs/object_pc.ply"
        save_2_ply(s_ply_path, pc_object_sampled[:, 0], pc_object_sampled[:, 1], pc_object_sampled[:, 2], color=None)

        s_ply_path = "/home/pxn-lyj/Egolee/programs/UniDexGrasp_liyj/dexgrasp_generation/local_files/data/table_pcs/table_pc.ply"
        save_2_ply(s_ply_path, pc_table_sampled[:, 0], pc_table_sampled[:, 1], pc_table_sampled[:, 2], color=None)
        exit(1)
...
if __name__ == '__main__':
    ...
    # camera 的使用https://simulately.wiki/docs/snippets/sapien/camera/
