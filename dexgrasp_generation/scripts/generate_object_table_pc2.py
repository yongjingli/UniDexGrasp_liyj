...
def sample_projected(_):
    ...
    for pose_matrix in pose_matrices:
        ...
        for idx_camera in range(len(camera_eye)):
            ...
            segmentation = camera.get_uint32_texture('Segmentation')  # [H, W, 4]
            ...
            points_opengl_object = position[..., :3][(position[..., 2] != 0) & (segmentation[..., 1] == 1)]
            ...
            points_opengl_table = position[..., :3][(position[..., 2] != 0) & (segmentation[..., 1] == 2)]
